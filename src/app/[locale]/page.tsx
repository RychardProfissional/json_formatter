    ...
    <main className="mx-auto max-w-5xl px-4 py-10">
      <section aria-label="Hero" className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          <Link className="rounded-xl bg-blue-600 px-4 py-2 font-semibold text-white hover:bg-blue-700" href={`${prefix}/tools`}>
            Acessar ferramentas
          </Link>
          <Link
      ...
      <section aria-label="Ferramentas" className="mt-10">
        ...
        <p className="mt-3 text-slate-600 dark:text-slate-300">
          O conteúdo principal do projeto fica em <Link className="font-semibold" href="/tools">/tools</Link>.
        </p>
      ...
      <section aria-label="FAQ" className="mt-10">
        ...
        <p className="mt-3 text-sm text-slate-500 dark:text-slate-400">
          Quer sugerir uma ferramenta? Fale pelo <Link className="font-semibold" href="/contato">contato</Link>.
        </p>
      </section>
